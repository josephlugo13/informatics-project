 ...
 */
    ...
    if (isset($_POST['submit'])) {
		...
		if (!$id) {
			$errorMessage .= "Please enter a ID for the new item. \n";
			$isComplete = false;
		}
		if (!$code) {
			$errorMessage .= "Please enter a code for the new item. \n";
			$isComplete = false;
		}
        if (!isset($category)) {
        ...
        if($isComplete) {
            ...
            $query = "UPDATE inventory SET code='$code', category='$category', product='$product', unit=$unit, price=$price, stock=$stock WHERE id=$id;";
...
<div class="form-group">
	...
	<input type="text" class="form-control" name="id" value="<?php if($id) { echo $id;} ?>" />
</div>

<!-- Code -->
<div class="form-group">
	<label for="code">Code: </label>
	<input type="text" class="form-control" name="code" value="<?php if($code) { echo $code;} ?>" />
</div>
