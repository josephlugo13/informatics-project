...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <ul class="nav navbar-nav navbar-left">
		...
		<li class="active"><a href="grocerOrders2.php"><span class="glyphicon glyphicon-send"></span> Delivered Orders</a></li>
...
<?php
	...
	$query = "SELECT orders.id, orders.customerName, orders.itemsOrdered, orders.totalPrice, orders.orderStatus FROM orders WHERE orderStatus='Delivered';";
	...
	while($row = nextTuple($result)) {
        ...
        echo "<td><a href='updateOrder2.php?id=" . $row['id']  .  "'>edit</a></td>";
		echo "</tr> \n";
