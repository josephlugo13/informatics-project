 ...
 */
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!isset($id)) {
            ...
            header('Location: grocerOrders3.php');
            exit;
        }
        ...
        if($isComplete) {
            ...
            header("Location: grocerOrders3.php?successmessage=Successfully updated order $id");
            exit;
        }        
    } else {
        //
...
<form action="updateOrder3.php" method="post">


<!-- orderStatus -->
<div class="form-group">
	<label for="orderStatus">Order Status: </label>
	<form action="updateOrder3.php">
